...
- Keep wide inline gaiji at the publisher's text-relative size, blend inline
  gaiji image backgrounds into the active Reader palette in light and dark
  themes, and exclude gaiji from image navigation.
